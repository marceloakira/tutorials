...
public class Estudante {
    ...
    public String toString() {
        if (this.nomeCompleto == null || this.matricula == 0) {
            return "Estudante [id=" + id + "]";
        }
        dataDeNascimento = dataDeNascimento == null ? "N/A" : dataDeNascimento;
        return this.nomeCompleto+" ("+this.matricula+") - "+dataDeNascimento+" [id="+id+"]";
    }    
